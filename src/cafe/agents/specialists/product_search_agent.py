"""Product Search specialist - handles menu lookups."""
...
from cafe.tools.product_tools import get_product_details, search_product_knowledge, search_products
...
def _make_toolkit() -> Toolkit:
    ...
    tk.register_tool_function(search_products)
    tk.register_tool_function(get_product_details)
